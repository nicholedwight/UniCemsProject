...
$YourEmail = "Ashley2.Dwight@live.uwe.ac.uk";
...
?>
	...
	<p><b>Thank You <?php echo $name; ?></b> an email has been sent to the address you gave.</p>
  	<p>You sent the following:</p>
		...
		<tr>
		<td>Telephone: </td><td> <b><?php echo $telephone; ?> </b></td>
		</tr>
		<tr>
 	...
 	<h2><a href="FormMail2.html">Go Back</a></h2>
<?php
	} 
...
?>
	...
	<p><a href="FormMail2.html">Please try again.</a></p>
